  ...
  List<Empty> get pageData {
    return [
      const Empty(
        ...
        isItemList: true,
        description: """
المصحف الشامل: أضفنا قسماً جديداً للقرآن الكريم (بالرسم العثماني) متكامل تماماً، مع إمكانية القراءة، البحث، والتفسير، بالإضافة إلى الاستماع بأصوات مشاهير القراء.
تكامل ذكي: يمكنك الآن الوصول للمصحف مباشرة من التبويبات الرئيسية في الشاشة الرئيسية لسهولة التنقل.
تحسينات الأداء: قمنا بضغط حجم التطبيق عبر استبدال صور المصحف القديمة بنظام عرض تقني حديث وأكثر سلاسة.
