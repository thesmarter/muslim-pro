...
import 'package:muslim/src/features/themes/data/models/alheek_design_system.dart';
...
class AppThemePreset {
  ...
  static const List<AppThemePreset> presets = [
    ...
    AppThemePreset(
      id: 'alheek',
      name: 'AlHeek',
      previewPrimary: Color(0xFF404C6E),
      previewSecondary: Color(0xFFbc8a5f),
      previewBackground: Color(0xFF1E1E1E),
      lightScheme: ColorScheme(
        brightness: Brightness.light,
      ...
      lightThemeBuilder: AlHeekDesignSystem.lightTheme,
      darkThemeBuilder: AlHeekDesignSystem.darkTheme,
    ),
    AppThemePreset(
      id: 'ottoman',
      name: 'Ottoman',
