...
- **Steps**:
    ...
    3.  **Packaging**: Takes the output of the build, places it into a folder named `muslim`, and compresses it into a `muslim.zip` file.
    4.  **Artifact Upload**: Uploads the `muslim.zip` file as an artifact.
